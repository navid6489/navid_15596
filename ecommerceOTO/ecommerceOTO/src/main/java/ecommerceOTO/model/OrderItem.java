...
public class OrderItem {
	...
	public OrderItem(int id, String name, String description, double unitprice,Product product) {
		super();
		this.id = id;
		this.name = name;
...
public OrderItem(String name, String description, double unitprice, Product product) {
		super();
		this.name = name;
		this.description = description;
		this.unitprice = unitprice;
